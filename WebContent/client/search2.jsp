...
%>
   ...
   <div id="top-image">
  	<input type="hidden" name="identity" value="common">
   <input style="font-family:'YouYuan';font-size:24px;color:white;background-color:transparent;
   border:0;position:absolute;right:12%" type="button" value="个人中心"onclick="location='${pageContext.request.contextPath }/client/cindex.jsp'">
