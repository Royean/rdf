...
{
%>
      <form action="${pageContext.request.contextPath}/cMyinfoupdateServlet" class="form-horizontal" method="post">
		...
		<div class="row">
			<div class="col-xs-12 col-xs-offset-4">
				...
				href="${pageContext.request.contextPath}/client/updatePassword.jsp" class="btn btn-success">修改密码</a>
			</div>
		</div>
        </form>
            <%} %>
