...
<div class="b">
		<p style="font-family:'Microsoft YaHei UI Light';color: white;font-size:36px;">请输入正确的用户名和邮箱</p>
		<p>
		</p>
		<a style="font-family:'Microsoft YaHei UI Light';color: white;font-size:20px;"
		href="${pageContext.request.contextPath}/client/resetPwd.jsp">
									<span style="font-family:'Microsoft YaHei UI Light';color: white;font-size:20px;" id="second">5</span>秒后自动为您转跳回当前页
								</a>
	</div>
