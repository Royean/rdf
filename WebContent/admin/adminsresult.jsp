...
.gbii{background-image:url(https://lh3.googleusercontent.com/-ikD5Vt9NfaY/AAAAAAAAAAI/AAAAAAAAAAA/AKxrwcaMJnRz_LdC_LkFpSAEdokWnPB8-g/s32-c-mo/photo.jpg)}.gbip{background-image:url(https://lh3.googleusercontent.com/-ikD5Vt9NfaY/AAAAAAAAAAI/AAAAAAAAAAA/AKxrwcaMJnRz_LdC_LkFpSAEdokWnPB8-g/s96-c-mo/photo.jpg)}@media (min-resolution:1.25dppx),(-o-min-device-pixel-ratio:5/4),(-webkit-min-device-pixel-ratio:1.25),(min-device-pixel-ratio:1.25){.gbii{background-image:url(https://lh3.googleusercontent.com/-ikD5Vt9NfaY/AAAAAAAAAAI/AAAAAAAAAAA/AKxrwcaMJnRz_LdC_LkFpSAEdokWnPB8-g/s64-c-mo/photo.jpg)}.gbip{background-image:url(https://lh3.googleusercontent.com/-ikD5Vt9NfaY/AAAAAAAAAAI/AAAAAAAAAAA/AKxrwcaMJnRz_LdC_LkFpSAEdokWnPB8-g/s192-c-mo/photo.jpg)}}
 ...
 <body class="srp tbo vasq" marginheight="3" topmargin="3" id="gsr">
  ...
  <div jscontroller="ZyRBae" jsaction="rcuQ6b:npT2md" class="jsrp" id="searchform"> 
   ...
   <form class="tsf nj" action="<%=request.getContextPath()%>/KeyServlet" style="overflow:visible" id="tsf" method="GET" name="f" onsubmit="return keyword.value!=''" role="search">
    <input type="hidden" name="identity" value="admin">
    <div jsmodel="vWNDde" jsdata="MuIEvd;;BU5NAE"> 
     <div jscontroller="mvYTse" class="A8SBwf" jsaction="DkpM0b:d3sQLd;IQOavd:dFyQEf;XzZZPe:jI3wzf;Aghsf:AVsnlb;iHd9U:Q7Cnrc;f5hEHe:G0jgYd;vmxUb:j3bJnb;R2c5O:LuRugf;qiCkJd:ANdidc;NOg9L:HLgh3;uGoIkd:epUokb;zLdLw:eaGBS;rcuQ6b:npT2md">
      <div class="logo">
       <a href="" title="rdf" id="logo" data-hveid="7"><img src="/rdf/RDF2.png" alt="Google" height="50" width="75" /></a>
      </div>
      <div class="RNNXgb" jsname="RNNXgb">
       <div class="SDkEP">
        <div jscontroller="iDPoPb" class="a4bIc" jsname="gLFyf" jsaction="dFyQEf;input:d3sQLd;focus:dFyQEf;blur:jI3wzf">
         <div class="vdLsw gsfi" jsname="vdLsw"></div>
         <input class="gLFyf gsfi" maxlength="2048" name="keyword" type="text" jsaction="paste:puy29d" aria-autocomplete="both" aria-haspopup="false" autocapitalize="off" autocomplete="off" autocorrect="off" role="combobox" spellcheck="false" title="rdf 搜索" value="<%=request.getParameter("keyword") %>" aria-label="搜索" />
        </div>
       </div> 
      ...
      <div jscontroller="tg8oTe" class="UUbT9" style="display:none" jsname="UUbT9" jsaction="h5M12e;mouseover:IgJl9c;mouseout:ItzDCd;mouseleave:MWfikb;YMFC3:VKssTb">
       <div class="RjPuVb" jsname="RjPuVb"></div>
       <div class="aajZCb" jsname="aajZCb">
        <ul class="erkvQe" jsname="erkvQe" role="listbox"></ul>
        <li class="sbct" id="sbt" role="presentation">
       ...
       <div jsname="JUypV" jscontroller="IvlUe" class="JUypV" data-async-context="async_id:duf3-46;authority:0;card_id:;entry_point:0;feature_id:;ftoe:0;header:0;open:0;suggestions:;suggestions_subtypes:;suggestions_types:;surface:0;title:;type:46">
        <div jscontroller="xz7cCd" style="display:none" jsaction="rcuQ6b:npT2md"></div>
        <div id="duf3-46" data-jiis="up" data-async-type="duffy3" data-async-context-required="type,open,feature_id,async_id,entry_point,authority,card_id,ftoe,title,header,suggestions,surface,suggestions_types,suggestions_subtypes" class="y yp" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQ-0EICA"></div>
        <a class="duf3 aciXEb" href="#" id="sbfblt" data-async-trigger="duf3-46" jsaction="async.u" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQtw8ICQ">举报不当的联想查询</a>
       </div>
      </div>
     </div> 
     <div jscontroller="TbaHGc" jsaction="rcuQ6b:npT2md"></div> 
    </div> 
   </form>
  </div>
  <div class="sfbgx"></div>
   ...
   <div class="spchc" id="spchc">
    <div class="inner-container">
     <div class="button-container">
      <span class="r8s4j" id="spchl"></span>
     ...
     <div class="text-container">
      <span class="spcht" id="spchi" style="color:#777"></span>
  ...
  <div id="main">
   ...
   <div id="cnt">
    <script nonce="wcHRwV+0+lSu0GfT/k21yg==">(function(){var j=1280;try{var c=document.getElementById('cnt');var s=document.getElementById('searchform');var n='';if(window.gbar&&gbar.elr){var m=gbar.elr().mo;n=(m=='md'?' mdm':(m=='lg'?' big':''));}else{var w=document.body&&document.body.offsetWidth;if(w&&w>=j){n=' big';}
}
c&&(c.className+=n);s&&(s.className+=n);}catch(e){}
    ...
    <style>.rwUYcf{display:inline-block}.Cq34nf{cursor:pointer}.cF4V5c{background:white;box-shadow:0 2px 10px 0 rgba(0,0,0,0.2);outline:none;padding:5px 0;position:absolute}a.f9UGee,a.f9UGee:visited{color:inherit;cursor:pointer;display:block;line-height:23px;outline:0;padding:3px 16px;text-decoration:inherit;white-space:nowrap}.f9UGee.t6psHzYPBsD__highlighted{background:rgba(0,0,0,0.1)}#ab_ctls a{text-decoration:none}#ab_ctls a.ab_button:active,#ab_ctls a.ab_dropdownlnk:active{color:#333}#bbar,#mbbar{background:#F9EDBE;border:1px solid #F0C36D;border-radius:2px;box-shadow:0px 2px 4px rgba(0,0,0,0.2);color:#333;left:50%;text-align:center;line-height:30px;padding:0 16px;bottom:-16px;position:absolute}#bbar a,#mbbar a{color:#333;margin-left:5px;text-decoration:underline}#resultStats{position:absolute;top:0;-webkit-transition:all 220ms ease-in-out;}</style>
    <div id="bst" style="display:none"></div>
    <div id="top_nav">
     <div jscontroller="qik19b" jsdata="Z1JpA;;BU5NAI" jsaction="rcuQ6b:npT2md">
      <h1 class="bNg8Rb">搜索模式</h1>
      <div class="hdtbna notl" id="hdtb" role="navigation" tabindex="0">
       
       <div class="hdtb-td-c hdtb-td-h" aria-expanded="false" id="hdtbMenus" tabindex="0" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQ3B8IIQ"></div>
      </div>
     </div>
    </div>
    ...
    <div class="mw">
     <div id="rcnt" style="clear:both;position:relative;zoom:1">
      ...
      <div class="col" id="rhscol">
       <div id="rhs">
        <div jscontroller="TxZWcc" data-find-map-using-id="1" jsdata="MdeVKb;;BU5NAQ" id="rhs_block" jsaction="rcuQ6b:npT2md">
         <script nonce="wcHRwV+0+lSu0GfT/k21yg==">(function(){var c4=1188;var c5=1276;try{var w=document.body.offsetWidth,n=3;if(w>=c4)n=w<c5?4:5;document.getElementById('rhs_block').className+=' rhstc'+n;}catch(e){}
})();</script>
     ...
     <div id="bfoot">
      <span style="display:none"> <span jscontroller="NBZ7u" style="display:none" data-d="1" data-lhe="1" data-lve="1" data-t="C" jsaction="rcuQ6b:npT2md"></span> </span>
    
     </div>
    </div>
    <div id="footcnt" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQpyoImAE">
     <style>.loc{}.swml-src{}.swml-upd{}.swml-loc{}.fbar p{display:inline}.fbar a,#fsettl{text-decoration:none;white-space:nowrap}.fbar{margin-left:-27px}.Fx4vi{padding-left:27px;margin:0 !important}#fbarcnt{display:block}.smiUbb img{margin-right:4px}.smiUbb a,.M6hT6 #swml a{text-decoration:none}#fsl{white-space:nowrap}.B4GxFc{margin-left:166px}#fbar{background:#f2f2f2;border-top:1px solid #e4e4e4;line-height:40px;min-width:1100px}.fbar p,.fbar a,#fsettl,#fsett a{color:#5f6368}.fbar a:hover,#fsett a:hover{color:#333}.fbar{font-size:small}.smiUbb{margin-left:166px;line-height:15px;color:#5f6368;}.b0KoTc{color:rgba(0,0,0,.54);padding-left:27px}#swml-loc{color:#333;font-weight:bold}#swml a{display:inline-block}.smiUbb a,#swml a{color:#5f6368}.smiUbb a:hover,#swml a:hover{color:#333}#swml{margin-left:0px}</style> 
     <h1 class="bNg8Rb">页脚链接</h1> 
     <div>
      <div id="fbarcnt" style="position:relative;visibility:hidden">
       <div id="fbar" class="mSAqxd" style="left:0;right:0">
        <div class="fbar b2hzT"> 
         <div class="b0KoTc B4GxFc"> 
          <div class="smiUbb" style="visibility:hidden;display: none" id="swml">
           <span id="loc"></span>
           <span id="swml-loc"></span>
           <span></span>
           <span id="swml-src"></span>
           <span></span>
           <a href="#" id="swml-upd" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQpLkCCJkB"></a>
           <span id="swml_lmsep">&nbsp;-&nbsp;</span>
           <a href="https://support.google.com/websearch?p=ws_settings_location&amp;hl=zh-CN" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://support.google.com/websearch%3Fp%3Dws_settings_location%26hl%3Dzh-CN&amp;ved=0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQty4ImgE">了解详情</a>
          </div> 
         </div> 
        </div>
        <div class="fbar">
         <span class="B4GxFc"><span id="fsl"><a class="Fx4vi" href="https://support.google.com/websearch/?p=ws_results_help&amp;hl=zh-CN&amp;fg=1" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://support.google.com/websearch/%3Fp%3Dws_results_help%26hl%3Dzh-CN%26fg%3D1&amp;ved=0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQ8KwCCJsB">帮助</a><a href="#" class="Fx4vi" data-bucket="websearch" id="dk2qOd" target="_blank" jsaction="gf.sf" data-ved="0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQLgicAQ">发送反馈</a><a class="Fx4vi" href="https://www.google.com/intl/zh-CN_us/policies/privacy/?fg=1" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://www.google.com/intl/zh-CN_us/policies/privacy/%3Ffg%3D1&amp;ved=0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQ8awCCJ0B">隐私权</a><a class="Fx4vi" href="https://www.google.com/intl/zh-CN_us/policies/terms/?fg=1" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://www.google.com/intl/zh-CN_us/policies/terms/%3Ffg%3D1&amp;ved=0ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQ8qwCCJ4B">条款</a></span></span>
        </div>
       </div>
      </div>
     </div> 
  ...
  <div class="gb_ab">
   <div class="gb_ca gb_ba gb_pa gb_va" aria-label="Google 应用" aria-hidden="true" role="region">
    <ul class="gb_ea gb_7" aria-dropeffect="move">
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="192" draggable="false" href="https://myaccount.google.com/?utm_source=OGB&amp;utm_medium=app" id="gb192">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_X" style="background-image:url('https://lh3.googleusercontent.com/-ikD5Vt9NfaY/AAAAAAAAAAI/AAAAAAAAAAA/AKxrwcaMJnRz_LdC_LkFpSAEdokWnPB8-g/s64-b8-cc-rp-mo/photo.jpg')"></span><span class="gb_Z">Google 帐号</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="1" draggable="false" href="https://www.google.com/webhp?tab=ww" id="gb1">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1311px"></span><span class="gb_Z">搜索</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="8" draggable="false" href="https://maps.google.com/maps?hl=zh-CN&amp;tab=wl" id="gb8">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -207px"></span><span class="gb_Z">地图</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="36" draggable="false" href="https://www.youtube.com/?gl=US" id="gb36">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -552px"></span><span class="gb_Z">YouTube</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="78" draggable="false" href="https://play.google.com/?hl=zh-CN&amp;tab=w8" id="gb78">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -2346px"></span><span class="gb_Z">Play</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="5" draggable="false" href="https://news.google.com/nwshp?hl=zh-CN&amp;tab=wn" id="gb5">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1035px"></span><span class="gb_Z">新闻</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="23" draggable="false" href="https://mail.google.com/mail/?tab=wm" id="gb23">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1104px"></span><span class="gb_Z">Gmail</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="53" draggable="false" href="https://contacts.google.com/?hl=zh-CN&amp;tab=wC" id="gb53">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -2139px"></span><span class="gb_Z">通讯录</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="49" draggable="false" href="https://drive.google.com/?tab=wo&amp;authuser=0" id="gb49">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -2001px"></span><span class="gb_Z">云端硬盘</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="24" draggable="false" href="https://www.google.com/calendar?tab=wc" id="gb24">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -828px"></span><span class="gb_Z">日历</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="119" draggable="false" href="https://plus.google.com/u/0/?gpsrc=ogpy0&amp;tab=wX" id="gb119">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -414px"></span><span class="gb_Z">Google+</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="51" draggable="false" href="https://translate.google.com/?hl=zh-CN&amp;tab=wT" id="gb51">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1656px"></span><span class="gb_Z">翻译</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="31" draggable="false" href="https://photos.google.com/?tab=wq&amp;pageId=none" id="gb31">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1518px"></span><span class="gb_Z">相册</span></a></li>
    </ul>
    <div class="gb_ra gb_ab">
     <div class="gb_0 gb_W" style="background-position:0 -1311px"></div>
     <div class="gb_sa">
      <div class="gb_ta">
       搜索
      </div>
      <a class="gb_ua gb_sg" href="#">添加快捷方式</a>
     </div>
    </div>
    <a class="gb_fa gb_sg" aria-label="更多 Google 应用" href="https://www.google.com/intl/zh-CN/about/products?tab=wh">更多</a>
    <span class="gb_ga"></span>
    <ul class="gb_ea gb_8" aria-dropeffect="move">
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="6" draggable="false" href="https://www.google.com/shopping?hl=zh-CN&amp;source=og&amp;tab=wf" id="gb6">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -345px"></span><span class="gb_Z">购物</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="27" draggable="false" href="https://www.google.com/finance?tab=we" id="gb27">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -2277px"></span><span class="gb_Z">财经</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="25" draggable="false" href="https://docs.google.com/document/?usp=docs_alc&amp;authuser=0" id="gb25">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1449px"></span><span class="gb_Z">文档</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="10" draggable="false" href="https://books.google.com/bkshp?hl=zh-CN&amp;tab=wp" id="gb10">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1242px"></span><span class="gb_Z">图书</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="30" draggable="false" href="https://www.blogger.com/?tab=wj" id="gb30">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -2070px"></span><span class="gb_Z">Blogger</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="300" draggable="false" href="https://hangouts.google.com/" id="gb300">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1587px"></span><span class="gb_Z">环聊</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="136" draggable="false" href="https://keep.google.com/u/0" id="gb136">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_M"></span><span class="gb_Z">Keep</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="357" draggable="false" href="https://jamboard.google.com/?authuser=0&amp;usp=jam_ald" id="gb357">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -897px"></span><span class="gb_Z">Jamboard</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="265" draggable="false" href="https://classroom.google.com/?authuser=0" id="gb265">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -621px"></span><span class="gb_Z">课堂</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="429" draggable="false" href="https://earth.google.com/web/" id="gb429">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1863px"></span><span class="gb_Z">Google 地球</span></a></li>
     <li class="gb_T" aria-grabbed="false"><a class="gb_O" data-pid="338" draggable="false" href="https://www.google.com/save" id="gb338">
       <div class="gb_3"></div>
       <div class="gb_4"></div>
       <div class="gb_5"></div>
       <div class="gb_6"></div><span class="gb_W" style="background-position:0 -1725px"></span><span class="gb_Z">收藏</span></a></li>
    </ul>
    <a class="gb_ga gb_ng" href="https://www.google.com/intl/zh-CN/about/products?tab=wh">来自 Google 的更多应用</a>
   </div>
   <div class="gb_xb gb_ba" aria-label="帐号信息" aria-hidden="true">
    <div class="gb_Ab">
     <a class="gb_Bb gb_sg" aria-label="更改个人资料照片" href="https://profiles.google.com/?hl=zh-CN&amp;tab=wX">
      <div class="gb_Eb" style="position:relative">
       <div class="gb_Fb gbip" title="个人资料"></div>
       <span class="gb_ob">更改</span>
      </div></a>
     <div class="gb_Cb">
      <div class="gb_Jb gb_Kb">
       roy gu
      </div>
      <div class="gb_Lb">
       gjw0505@hnu.edu.cn
 ...
 var uri_list = ['http://bio2rdf.org/ns/chebi#Compound',
	 ...
	 'http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/drug_interactions',
	 'http://www.w3.org/2000/01/rdf-schema#Class',
	 'http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/drugs',
	 'http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/enzymes',
	 'http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/references',
	 'http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/targets',
	 ...
	 'http://bio2rdf.org/ns/kegg#Enzyme',
	 'http://bio2rdf.org/ns/kegg#Reaction']

 	
 	var string_0 = "<div class='g'><div data-hveid='CAkQAA' data-ved='2ahUKEwi_oL-1gMLfAhXjnuAKHcAEDBkQFSgAMAB6BAgJEAA'><div class='rc'><div class='r'><h3 class='LC20lb' id='title'>"; 
	var string_1 = "</h3><br/><div style='display:inline-block' class='TbwUpd'></div></div><div class='s'><div><span class='st' id='cntspan'><em>";
	var string_2 = "</em></span>";
	var string_3 = "<a href='../sparql/NO."; 
	var string_4 = ".txt' download='SPARQL.txt'>点击下载</a>";
	var string_5 = "</div></div></div></div></div>";
	var title;
	...
	function insert(){ 
		var arr = [];
		var reg = /[0-9]+/g;
		var numList = title.match(reg);
		for(var j = 0,len = numList.length; j < len; j++){
    		arr.push(parseInt(numList[j]));
    		//console.log(arr[j]);
		}
		var urls="";
		var br=0;
		for(var j = 0,len = numList.length; j < len; j++){
    		var tmp = uri_list[arr[j]];
			if(br == 2){
				urls+="<a href='"+tmp+"'>"+tmp+"</a></br>";
				br=0;
			}
    		else{
    			urls+="<a href='"+tmp+"'>"+tmp+"</a>&nbsp&nbsp&nbsp&nbsp&nbsp";
    			br++;
    		}
    		console.log(uri_list[arr[j]]);
		}
		var string_tmp = string_2;
		if(br == 1 || br == 2){
			string_tmp += "</br>";
		}
		// 采用字符串拼接的方式来插入字符串
		console.log(urls);
		var cnt = string_0 + title + string_1 + urls + string_tmp + string_3 + (count++) + string_4 + string_5;
		document.getElementById("fatherbox").innerHTML = document.getElementById("fatherbox").innerHTML+cnt; 
	}
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket("ws://47.92.162.51:8080/rdf2/websocket");
    }
    else {
    ...
    websocket.onopen = function () {
        var kw=getQueryVariable("keyword")+"&"+<%=request.getParameter("key_id")%>;
        //setMessageInnerHTML(kw);
        send(kw); 
